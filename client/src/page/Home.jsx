...
const handleStop=()=>{
  ...
  return (
    ...
    <section className="max-w-7xl mx-auto">
      <div > 
        <h1 className="font-extrabold text-[#222328] text-[43px] mx-auto">The Community Showcase</h1>
        <p className="mt-2 text-[#666e75] text-[20px] max-w-[500px]">Browse through a collection of imaginative and visually stunning images generated by DALL-E AI</p>
      </div>

      <div className="mt-16 mb-4">
        <FormField
          labelName="Filter posts"
          type="text"
          name="text"
      ...
      <div className="mb-4">
       "{transcript?transcript:"Your Voice here"}"
      </div>
